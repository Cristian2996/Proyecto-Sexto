...
<%
    List<Cliente> lista = Cliente.clientes_buscartodos();
    ...
    <body>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-danger" href='procesa_eliminar.jsp?codigo=<%= cliente.getId_cliente()%>' onclick="return confirm('¿Está seguro que desea eliminar este registro?');">Eliminar</a>
                    <button type="button"  onclick="return modaleditar(<%= cliente.getId_cliente()%>)" class="btn btn-primary" data-toggle="modal" data-target="#ModalEditar">Editar</button>  
