    ...
    if (alerta.equals("si")){%>
       ...
       <% }%>
        <!--Fin Sección alerta-->
         ...
         <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalNuevo"> Nuevo</button>  
          <%@include file="/mod_inventario/productos/nuevo.jsp" %>
